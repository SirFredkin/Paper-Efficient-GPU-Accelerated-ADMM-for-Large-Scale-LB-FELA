...
\begin{figure}
\centering\includegraphics[width=0.8\textwidth]{figures/Res_To_Date/2PR_mesh.png} 
...
& & ADMM   & 33.21  & 5.11945 & 620 & 0.054 \tabularnewline
...
& & ADMM   & 6.50 & 3.77255&  460  & 0.025 \tabularnewline
...
& & ADMM   & 7.08  & 3.77330 & 340 & 0.035\tabularnewline
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.32\textwidth]{figures/Res_To_Date/TC2PR.png}
  \hfill
  \includegraphics[width=0.32\textwidth]{figures/Res_To_Date/TCSF.png}
  \hfill
  \includegraphics[width=0.32\textwidth]{figures/Res_To_Date/TCVC.png}
  \caption{Timing comparison of ADMM against IPM solvers in 2D benchmark problems (From left to right: Rigid platen, strip footing, vertical cut)}
...
\begin{figure}
\centering\includegraphics[width=0.8\textwidth]{figures/Res_To_Date/AMR_A1000.png} 
...
As in the 2D examples, the proposed ADMM solver remains competitive in the 3D benchmarks, achieving a speedup of approximately \(2\times\) to \(4\times\) over MOSEK. Gurobi is consistently slower across the cases considered. Although the speedup is less pronounced than that observed for the 2D problems, the underlying reasons are discussed in the following section. Nevertheless, the computational cost per ADMM iteration remains substantially lower than that of an IPM iteration. Moreover, with warm-starting and active-cone identification, the number of ADMM iterations varies only moderately as the problem size increases.

The use of adaptive mesh refinement also yields tighter lower-bound solutions and provides a more detailed representation of the failure region. However, a clearly defined 3D 'slip surface' is not fully resolved, primarily because achieving the required level of mesh refinement would incur prohibitive computational cost.